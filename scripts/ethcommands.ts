...
async function bridgeFunds(argv: any, parentChainUrl: string, chainUrl: string, inboxAddr: string) {
  argv.provider = new JsonRpcProvider(parentChainUrl);
...
// export const waitForSyncWebSocketCommand = {
//   command: "wait-for-sync-ws",
//   describe: "wait for WebSocket to sync",
//   builder: {
//     url: { string: true, describe: "WebSocket url to connect", default: "wss://wss-d11k.dojima.network" },
//   },
//   handler: async (argv: any) => {
